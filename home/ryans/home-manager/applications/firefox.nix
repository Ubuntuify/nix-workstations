...
lib.mkIf config.perpensity.roles.graphics (lib.mkMerge [
  {
    ...
    programs.firefox = {
      ...
      profiles.ryan = {
        ...
        settings = {
          ...
          "privacy.firstparty.restrict_opener_access" = false;
          "image.jxl.enabled" = true; # enable JPEG-XL support
          "browser.tabs.insertRelatedAfterCurrent" = false;
          "general.smoothScroll.msdPhysics.enabled" = true;

          "browser.tabs.min_inactive_duration_before_unload" =
            if config.perpensity.roles.ramConservation # check if the system is a Low RAM machine
